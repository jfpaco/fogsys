...
namespace FogaLib
{
    public class Seguridad
    {
        ...
        public Seguridad()
        {            
            key = "ABCDEFGHIJKLMÑOPQRSTUVWXYZabcdefghijklmnñopqrstuvwxyz0123456789";
        }

        public string Encriptar(string texto, bool archivo)
        {
        ...
        public string Desencriptar(string textoEncriptado, bool archivo)
        {
            byte[] keyArray;
